...
Las decisiones de diseño y lo que cada una costó descubrir. El [README](../README.md)
dice qué es el proyecto; esto dice **por qué está hecho así**.

Casi todo lo de aquí se aprendió rompiendo algo primero. Cuando una sección
suena a regla arbitraria, suele haber un fallo detrás, y está contado.
